...
String imgpth=null;
    ...
    private void initComponents() {
        ...
        img2.setIcon(new javax.swing.ImageIcon("C:\\Users\\lenovo\\Desktop\\java project images\\New folder\\circle-cropped.png")); // NOI18N
        jPanel2.add(img2, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 230, 110, -1));
    ...
    private void Register_userActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Register_userActionPerformed
        ...
        try {
            ps=con.prepareStatement("INSERT INTO `students`(`first_name`, `last_name`, `mother`, `father`, `email`, `uname`, `password`, `photo`) VALUES (?,?,?,?,?,?,?,?)");
...
//        jc.setVisible(true);
 ...
 int result=      jfc.showOpenDialog(this);
   ...
   pst=con.prepareStatement("insert into students(photo) values(?)");
