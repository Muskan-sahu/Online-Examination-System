...
public class Convert extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String filename=f+"\\"+jTextField2.getText();
           ...
           Connection con;
            ...
            PreparedStatement ps=con.prepareStatement("select * from questions_c");
            ResultSet rs= ps.executeQuery();
            while(rs.next())
            {
              Paragraph para=new Paragraph(rs.getString("qid")+"\t "+rs.getString("questions")+"\n a- "+rs.getString("ans_1")+"\t b- "+rs.getString("ans_2")+"\t c- "+rs.getString("ans_3")+"\t d- "+rs.getString("ans_4")+"\n correct_ans- "+rs.getString("correct_ans"));
               document.add(para);
