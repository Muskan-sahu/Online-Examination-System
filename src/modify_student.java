 ...
 int result=      jfc.showOpenDialog(this);
    ...
    imgpth=fname;
     ImageIcon imgicon=new ImageIcon(imgpth);
      Image img = imgicon.getImage().getScaledInstance(imgl.getWidth(),imgl.getHeight(),Image.SCALE_SMOOTH);
                ImageIcon icon=new ImageIcon(img);
                imgl.setIcon(icon);
       }
       }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       Connection con=Myconnection.getConnection();
        ...
        try {
            ps=con.prepareStatement("UPDATE students SET first_name=?, last_name=?, mother=?, father=?, email=?, uname=?, password=?,photo=? WHERE Uid=?");
            ...
            ps.setString(7, String.valueOf(pass.getPassword())); 
               ...
               InputStream is=new FileInputStream(new File(imgpth));
                ps.setBlob(8,is);
               ps.setString(9, get_info_text.getText());
                 ps.executeUpdate();
